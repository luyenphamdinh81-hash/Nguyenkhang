...
local Window = Fluent:CreateWindow({
	Title = "VK hub =}",         -- 👈 đổi thành tên script của bạn
	SubTitle = " premium",              -- 👈 đổi mô tả phụ
	TabWidth = 157,
	Size = UDim2.fromOffset(450, 300),
	Acrylic = true,
	Theme = "Aqua",                   -- 👈 đổi màu chủ đạo: Amethyst, Dark, Aqua, Light,...
	MinimizeKey = Enum.KeyCode.End
})

-- 📑 Các tab (mục chính)
local Tabs = {
	Main0 = Window:AddTab({ Title = "main farm" }),  -- 👈 đổi tên tab 1
	Main1 = Window:AddTab({ Title = "setting farm" }),  -- 👈 đổi tên tab 2
	Main2 = Window:AddTab({ Title = "ofter farm" }),     -- 👈 đổi tên tab 3
	Main3 = Window:AddTab({ Title = "stack farm" }),        -- 👈 đổi tên tab 4
	Main4 = Window:AddTab({ Title = "sea event" }),    -- 👈 đổi tên tab 5
	Main5 = Window:AddTab({ Title = "dragon dojo" }) -- 👈 đổi tên tab 6
}
